...
public class JSONPatchRequestRemove implements PatchRequestInner {
   ...
   */
  public JSONPatchRequestRemove(String path, OpEnum op) {
    this.path = path;
    this.op = op;
  }

  public JSONPatchRequestRemove path(String path) {
    this.path = path;
    return this;
  }
  ...
  public JSONPatchRequestRemove op(OpEnum op) {
    this.op = op;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    JSONPatchRequestRemove jsONPatchRequestRemove = (JSONPatchRequestRemove) o;
  ...
  public String toString() {
    ...
    sb.append("class JSONPatchRequestRemove {\n");
